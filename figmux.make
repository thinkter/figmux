...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/figmux
OBJDIR = obj/x64/Debug/figmux
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/figmux
OBJDIR = obj/ARM64/Release/figmux
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(OBJDIR)/main.o: src/main.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/pane_manager.o: src/pane_manager.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
